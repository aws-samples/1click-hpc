...
wget -nv https://raw.githubusercontent.com/aws-samples/1click-enginframe/main/parallelcluster/${PC_CONFIG}
...
sudo wget -nv https://raw.githubusercontent.com/aws-samples/1click-enginframe/main/scripts/motd -O /etc/update-motd.d/10-HPC
