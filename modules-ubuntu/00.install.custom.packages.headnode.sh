...
installCustom() {
    ...
    sudo apt-get -q -o DPkg::Lock::Timeout=240 install -y build-essential wget tmux htop hwloc iftop aria2 numactl check subunit inotify-tools bwm-ng subunit rustc cargo 
